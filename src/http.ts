...
export class ZoneMacroTaskConnection extends ZoneMacroTaskWrapper<Request, Response> implements Connection {
...
export function zoneWrappedInterceptingHandler(backend: HttpBackend, interceptors: HttpInterceptor[] | null) {
